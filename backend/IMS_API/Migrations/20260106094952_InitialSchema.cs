        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastStockUpdateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "FullName", "PasswordHash", "PasswordSalt", "RefreshToken", "RefreshTokenExpiry", "Role", "UpdatedAt", "Username" },
                values: new object[] { 1, new DateTime(2026, 1, 6, 9, 49, 48, 975, DateTimeKind.Utc).AddTicks(9495), "System", new byte[0], new byte[0], null, null, "", null, "system" });
